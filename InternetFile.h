...
#define INTERNET_FILE_END_TAG_PREFIX											ASCII_FORWARD_SLASH_CHARACTER
...
#define INTERNET_FILE_UNABLE_TO_GET_TARGET_URL_ERROR_MESSAGE_FORMAT_STRING		"Unable to get Target URL for %s"
