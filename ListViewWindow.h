...
#define LIST_VIEW_WINDOW_COLUMN_TITLES											{ "Url", "Local File Path" }

typedef enum
{
	LIST_VIEW_WINDOW_URL_COLUMN_ID = 0,
	LIST_VIEW_WINDOW_LOCAL_FILE_PATH_COLUMN_ID,
...
BOOL ListViewWindowSetItemTextEx( int nWhichItem, int nWhichSubItem, LPCTSTR lpszItemText, DWORD dwMaximumTextLength = STRING_LENGTH );
