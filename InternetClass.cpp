...
BOOL Internet::Download( LPCTSTR lpszUrl, LPTSTR lpszLocalFilePath )
{
	BOOL bResult = FALSE;
...
BOOL Internet::Open( LPCSTR lpszAgent, DWORD dwAccessType, LPCTSTR lpszProxy, LPCTSTR lpszProxyBypass, DWORD dwFlags )
{
	BOOL bResult = FALSE;
